...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () => import('./features/trips/join-trip.component').then(m => m.JoinTripComponent),
  },
  {
    path: '',
    canActivate: [authGuard],
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () => import('./features/trips/trip-members.component').then(m => m.TripMembersComponent),
      },
      {
        path: 'exchange',
        loadComponent: () => import('./features/exchange/exchange.component').then(m => m.ExchangeComponent),
      },
      {
        path: 'account',
